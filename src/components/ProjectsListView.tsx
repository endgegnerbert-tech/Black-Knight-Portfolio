...
export default function ProjectsListView({
  ...
  return (
    <div className="min-h-full flex flex-col justify-start md:justify-center animate-fadeIn pt-4 pb-8 md:py-0">
      {aiProjects.length > 0 && (
        <div>
          <h3 className="text-sm md:text-base text-gray-500 uppercase tracking-widest font-light mb-4">
            AI Projects
          </h3>
      ...
      {nonAiProjects.length > 0 && (
        <div>
          {aiProjects.length > 0 && (
            <h3 className="text-sm md:text-base text-gray-500 uppercase tracking-widest font-light mb-4 mt-8">
              Other Projects
            </h3>
          )}
